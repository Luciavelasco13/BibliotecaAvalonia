...
namespace BibliotecaAvalonia.Modelos
{
    ...
    {
        public int Nota { get; set; }           // 0-10 obligatorio
        public string Comentario { get; set; } = string.Empty;   // opcional
    ...
    public class Libro : Articulo, IPrestable, IValorable
    {
        ...
        // CORREGIDO: calcula la media real de las notas
        public double CalcularMedia()
            => Valoraciones.Count == 0 ? 0 : Valoraciones.Average(v => v.Nota);

        // Añadir valoración con validación (nota 0-10 obligatoria)
    ...
    public class Audiolibro : Articulo, IValorable
    {
        ...
        // CORREGIDO: calcula la media real
        public double CalcularMedia()
            => Valoraciones.Count == 0 ? 0 : Valoraciones.Average(v => v.Nota);
