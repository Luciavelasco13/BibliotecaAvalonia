...
namespace BibliotecaAvalonia.Utilidades
{
    ...
    {
        // ---------------------------------------------------------------
        // EXPORTAR – todos los artículos (libros + audiolibros)
        ...
        public static List<Articulo> importar_csv(string ruta)
        {
            ...
            while ((linea = reader.ReadLine()) != null)
            {
                ...
                {
                    // Línea mal formada → se ignora y se continúa
                }
            }
            return lista;
        }

        // Escapar punto y coma en valores de texto para no romper el CSV
