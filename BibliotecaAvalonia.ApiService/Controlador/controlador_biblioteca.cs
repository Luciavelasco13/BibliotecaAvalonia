...
using BibliotecaAvalonia.Utilidades;

namespace BibliotecaAvalonia.Controlador
{
    public partial class controlador_biblioteca : ObservableObject
    {
        ...
        // ---------------------------------------------------------------
        // Propiedades observables para el formulario de Libro
        // ---------------------------------------------------------------
        [ObservableProperty] private string _txtTitulo = string.Empty;
        [ObservableProperty] private string _txtIsbn = string.Empty;
        [ObservableProperty] private string _txtAnio = string.Empty;   // CORREGIDO: faltaba en la versión original
        ...
        [ObservableProperty] private string _filtroTipo = string.Empty; // "Libro", "Audiolibro" o ""
        ...
        // ---------------------------------------------------------------
        // AGREGAR LIBRO
        // CORREGIDO: antes llamaba a _bd.insertar_libro() (tabla Libros
        //            inexistente). Ahora usa _bd.insertar_articulo().
        // ---------------------------------------------------------------
        [RelayCommand]
        public void AgregarLibro()
        {
            ...
            _bd.insertar_articulo(nuevo);   // ← CORREGIDO
        ...
        // ---------------------------------------------------------------
        // EDITAR – actualiza el artículo seleccionado con los datos del form
        // ---------------------------------------------------------------
        [RelayCommand]
        public void Editar()
        {
        ...
        // ---------------------------------------------------------------
        // EXPORTAR CSV (todos los artículos)
        // CORREGIDO: antes solo exportaba libros
        // ---------------------------------------------------------------
        [RelayCommand]
